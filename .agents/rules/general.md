...
- Use componentes da biblioteca shadcn/ui o máximo possível ao criar/modificar components (veja https://v3.shadcn.com/docs/components/accordion para a lista de componentes disponíveis) e sempre utilize a versão @2.5.0. Exemplo: npx shadcn@2.5.0 add tabs
